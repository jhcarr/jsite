...
get the app created:
    ...
    $ heroku apps:create jsite
    Creating jsite... done, stack is cedar
    http://jsite.herokuapp.com/ | git@heroku.com:jsite.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://jsite.herokuapp.com deployed to Heroku

    To git@heroku.com:jsite.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://jsite.herokuap.com
    ["Hello" :from Heroku]
